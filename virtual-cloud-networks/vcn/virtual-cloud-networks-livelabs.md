...
1. To view subnets, navigate Virtual Cloud Network. Then to the Subnet tab for your VCN. Click on your pre-created subnet.
    ![Screenshot showing where to find VCN](./images/vcn.png)
    ![Screenshot showing to select VCN](./images/select-vcn.png)
    ![Screenshot showing where to click on subnet](./images/subnet-select.png)
...
1. To view Gateways, navigate to the Gateways tab for your VCN. Here, you can create different Gateways to use.

    ![Screenshot showing where to find gateways](./images/view-gateways.png)
...
### **Viewing Route Tables and Route Rules**

1. To view Route Tables, navigate to the Routing tab for your VCN. Click on the pre created Route Table.
    ![Screenshot showing where to find route tables](./images/view-route-tables.png)

2. Click on **Route Rules** to view routes.
    ![Screenshot showing route rules](./images/route-rules-1.png)
...
### **Viewing Security Lists and Rules**

1. To view a Security List, navigate to the Security tab for your VCN. Click on one of the pre created Security Lists.

    ![Screenshot showing where to find security lists](./images/view-sl.png)

2. Click **Security Rules** to view all ingress and egress rules for the security list.

    ![Screenshot showing how to create a security list](./images/view-security-rules.png)
